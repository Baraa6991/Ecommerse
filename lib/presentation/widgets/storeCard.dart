...
class Storecard extends StatelessWidget {
  final Store stores;
  const Storecard({super.key, required this.stores});
        ...
        Navigator.push(
          ...
          MaterialPageRoute(
            builder: (context) => Productid(
              store: convertStoreToStoresId(stores),
            ),
          ),
        );
      },
...
StoresId convertStoreToStoresId(Store store) {
  return StoresId(
    id: store.id,
    name: store.name,
    image: store.image,
